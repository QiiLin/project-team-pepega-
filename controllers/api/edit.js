...
router.post("/transition/:id", auth, (req, res) => {
  ...
  let path1_base = path.basename(path1).replace(path.extname(path1), "");
  // console.log("path1_base: ", path1_base);
  let path1_tmp = path.join(
    path.dirname(path1),
    "tmp",
    path1_base + "_1" + ".webm"
  ); //temp file loc
  console.log("path1_tmp: ", path1_tmp);
  let path2_tmp = path.join(
    path.dirname(path1),
    "tmp",
    path1_base + "_2" + ".webm"
  );
  console.log("path2_tmp: ", path2_tmp);
  let pathOut_tmp = path.join(__dirname, "../../video_output/tmp");
  console.log("pathOut_tmp: ", pathOut_tmp);
