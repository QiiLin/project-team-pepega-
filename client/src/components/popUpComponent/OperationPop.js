...
class OperationPop extends React.Component {
  ...
  renderResultContent() {
    ...
    return <span>Operation Sucessed, new video file {this.props.newFileName} is created, you can now view it from the list</span>;
  }
  renderProgressContent() {
      if (this.props.loading) {
          return <div className="alignCenter"><CircularProgress/> </div>;
      }
